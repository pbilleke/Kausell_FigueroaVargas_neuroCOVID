...
#   pbilleke@udd.cl
#
#   PASO 1 : hacer las suferfisies corticales cpn freesurfer 
#
...
field_maps=(`ls $DB/${GRUPO}/${SUJETO}/MRI/*field_map_*.nii.gz`)
...
#rm `ls /Volumes/$DB/${GRUPO}/${SUJETO}/MRI/**_t2_spc_sag_p2_iso*`


###  Agregar los cambios de nobre de T1 y T2 

PreFreeSurferPipelineBatch_noFM.sh --Subjlist=$SUJETO --DA=${DA} --StudyFolder=$DB/${GRUPO}/
