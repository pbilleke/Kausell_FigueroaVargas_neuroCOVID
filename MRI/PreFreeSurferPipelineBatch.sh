...
for Subject in $Subjlist ; do
  ...
  AvgrdcSTRING="FIELDMAP" #   Averaging and readout distortion correction methods: 
  ...
  MagnitudeInputName="${StudyFolder}/${Subject}/MRI/${Subject}_${DA}_field_map_Mag.nii.gz" #  "NONE" #"${StudyFolder}/${Subject}/unprocessed/3T/T1w_MPR1/${Subject}_3T_FieldMap_Magnitude.nii.gz" #"NONE" 
  ...
  PhaseInputName="${StudyFolder}/${Subject}/MRI/${Subject}_${DA}_field_map_F.nii.gz" #"${StudyFolder}/${Subject}/unprocessed/3T/T1w_MPR1/${Subject}_3T_FieldMap_Phase.nii.gz" #"NONE" 
